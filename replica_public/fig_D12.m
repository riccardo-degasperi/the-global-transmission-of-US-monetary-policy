...
%                                                                         %
% Replica of Figure D.12                                                  %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.12:  ./plots/fig_D12/Global_BVAR_multishocks_varplot.pdf          %
%                                                                         %
...
for z = 1:UU
    ...
    dataOpt.varendo_global  = {'USIP','USCPI','USSPRDUeom','USXtoM','USTVOL','USNER','USGBY','GZEBP','VIX',shocks{z},'ROILP','GS1'};
    dataOpt.varplot         = {'OECDIP','OECDCPI','USIP','USCPI',shocks{z},'ROILP','GS1'};
    ...
    plotOpt.folder          = ['fig_D12/',shocks{z}];  %either a folder name or []
...
longnames(5) = {'Commodity Price Index'};

plotOpt.ylab = ylab0(iPlot);
legNames = {'Real GSCI','Nominal GSCI','baseline'};
chartName = 'Global_BVAR_multishocks_varplot';
IRFdisplay_stack2(stoBVAR_varplot,varplot,longnames,shockVar,legNames,'varplot',plotOpt,chartName)