...
%                                                                         %
% Replica of Figure D.7                                                   %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.7 :  ./plots/fig_D7/Global_BVAR_multishocks_varplot_1.pdf         %
%                                                                         %
...
for z = 1:UU
    ...
    plotOpt.folder          = ['fig_D7/',shocks{z}]; %either a folder name or []
