function [out,csmin,postMode] = GLPoptimalPriorsTriangular(Y,X,Ybar,Xbar,hp,dims)
    ...
    if hyperpriors
        ...
        mode.l1 = 0.4;                      %0.4 Miranda & Ricco; 0.2 Sims
        mode.l3 = 1;
        mode.l4 = 1;

        % Define standard deviations of the hyperpriors
        sd.l1   = 0.2;                      %0.2 Miranda & Ricco; 0.4 Sims
        sd.l3   = 1;
        sd.l4   = 1;
    ...
    [fh,postMode.beta,postMode.sigma] = logMLVAR_formin_mod(xh,Y,X,p,m,T-p,N,b,MIN,MAX,hp.SS2,hp.l2,hp.l5,hp.iRW,iPrior,Ybar,Xbar,hyperpriors,priorcoef);
