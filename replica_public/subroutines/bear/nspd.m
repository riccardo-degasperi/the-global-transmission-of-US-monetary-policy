...
% NOTE: test1 can differ if instead of chol(A,'lower') you compute it on
% chol(A,'upper'). Therefore use this in conjunction with the 'lower'
% command to avoid errors.
% Riccardo Degasperi (taken from BEAR toolbox)
