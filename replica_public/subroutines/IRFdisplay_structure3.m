function [ ] = IRFdisplay_structure3(IRFstruc,varlist,longnames,shockVar,legNames,style,plotCase,plotOpt,chartName)
% Plots IRFs
...
%     title(['Shock to: ',ShockName],'FontSize',11,'FontName','Times New Roman','FontWeight','normal');
    ...
    set(gcf,'PaperUnits','centimeters','PaperSize',[6.5*kk*cols 6.5*kk*rows]) %[x y]
    set(gcf,'PaperPosition',[0.25*kk*cols 0.25*kk*rows 5.75*kk*cols 5.75*kk*rows])  %[left bottom width height]
