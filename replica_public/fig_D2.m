...
%                                                                         %
% Replica of Figure D.2                                                   %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.2 : ./plots/fig_D2/Global_BVAR_multishocks_varplot_WIP_1.pdf      %
%                                                                         %
...
for z = 1:UU
    ...
    plotOpt.folder          = ['fig_D2/',IP{z}];    %either a folder name or []
...
longnames(1:2) = {'World ex. US & OECD production','World ex. US & OECD CPI'};
