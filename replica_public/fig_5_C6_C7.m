...
%                                                                         %
% Replica of Figures 5, C.6, C.7                                          %
%                                                                         %
% URL to the file:                                                        %
% Fig.5   :  ./plots/fig_5_C6_C7/SSA/Global_Triangular_Chan_No_oil_price_SSA_GS1_varplot_overlaid_1.pdf
% Fig.C.6 :  ./plots/fig_5_C6_C7/Global_Triangular_Chan_varendo_ROILP_1.pdf
% Fig.C.7 :  ./plots/fig_5_C6_C7/SSA/Global_Triangular_Chan_No_oil_price_SSA_GS1_shockDistribution
%                                                                         %
...
ssaOpt.SSAy             = {{'ROILP'}};          %variables whose path is restricted (can define many in this format SSAy = {{'var1','var2'};{'var1'};{'var1','var2','var3'}};)
...
plotOpt.folder          = 'fig_5_C6_C7';        %either a folder name or []
