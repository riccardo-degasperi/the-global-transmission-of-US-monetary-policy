...
%                                                                         %
% Replica of Figure D.4.b                                                 %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.4.b :  ./plots/fig_D4/overlay/EM_MARextended_comparison.pdf       %
%                                                                         %
...
EMmodelOpt = load('sto_EMs_MARext/modelOpt');
EMdataOpt  = load('sto_EMs_MARext/dataOpt');
EMplotOpt  = load('sto_EMs_MARext/plotOpt');
EMmiscOpt  = load('sto_EMs_MARext/miscOpt');

% Load IRFs
load('sto_EMs/sto_groupBaseline_BVAR_t');
AEIRF = IRFmedian;
load('sto_EMs_MARext/sto_groupBaseline_BVAR_t');
EMIRF = IRFmedian;
...
chartName = 'EM_MARextended_comparison';
