...
%                                                                         %
% Replica of Figure D.8.b                                                 %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.8.b :  ./plots/fig_D8/overlay/EM_BS_comparison.pdf                %
%                                                                         %
...
EMmodelOpt = load('sto_EMs_BS/modelOpt');
EMdataOpt  = load('sto_EMs_BS/dataOpt');
EMplotOpt  = load('sto_EMs_BS/plotOpt');
EMmiscOpt  = load('sto_EMs_BS/miscOpt');

% Load IRFs
load('sto_EMs/sto_groupBaseline_BVAR_t');
AEIRF = IRFmedian;
load('sto_EMs_BS/sto_groupBaseline_BVAR_t');
EMIRF = IRFmedian;
...
% Plot figure
AEplotOpt.folder = 'fig_D8/overlay/';
legNames = {'Bauer-Swanson','Baseline'};
chartName = 'EM_BS_comparison';
