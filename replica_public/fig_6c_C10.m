...
%                                                                         %
% Replica of Figures 6.c, C.10                                            %
%                                                                         %
% URL to the file:                                                        %
% Fig.6.c :  ./plots/fig_6c_C10/AA__median-median_overlaid_custom_1.pdf   %
% Fig.C.10:  ./plots/fig_6c_C10/AA__median-median_overlaid_1.pdf          %
%                                                                         %
...
for z = 1:UU
    ...
    plotOpt.folder          = 'fig_6c_C10';         %either a folder name or []
    ...
    stoFolder = 'sto_EMs_CF_alt';                      %folder where to save IRF mat files
