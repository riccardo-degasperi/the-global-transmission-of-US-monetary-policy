...
%                                                                         %
% Replica of Figure 1 but dropping proprietary data                       %
%                                                                         %
% URL to the file:                                                        %
% Fig.1 :  ./plots/fig_1_public/Global_FullGibbs_varendo_1.pdf            %
%                                                                         %
...
dataOpt.varendo         = {'OECDIP','OECDCPI','OECDSPRDUeom','EMINFLOW','EMOUTFLOW','DIRADV','EURUSD','GBPUSD','JPYUSD','GEAI'};
dataOpt.varendo_global  = {'USIP','USCPI','USSPRDUeom','USXtoM','USTVOL','USNER','USGBY','USINFLOW','USOUTFLOW','GZEBP','VIX','RCRBPI','ROILP','GS1'};
dataOpt.varplot         = {'OECDIP','OECDCPI','OECDSPRDUeom','EMINFLOW','EMOUTFLOW','DIRADV','EURUSD','GBPUSD','JPYUSD','RCRBPI','ROILP','GEAI'};   %selected variables to plot
...
modelOpt.shutVar      = {'OECDIP','OECDCPI','OECDSPRDUeom','EMINFLOW','EMOUTFLOW','DIRADV','EURUSD','GBPUSD','JPYUSD'};   %parameters whose prior variance is 0
...
plotOpt.folder          = 'fig_1_public';       %either a folder name or []
