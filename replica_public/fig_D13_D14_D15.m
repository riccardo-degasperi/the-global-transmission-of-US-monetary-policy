...
%                                                                         %
% Replica of Figures D.13, D.14, D.15                                     %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.13:  ./plots/fig_D13_D14_D15/AA_commodity_median-median_varplot_1.pdf
% Fig.D.14:  ./plots/fig_D13_D14_D15/AA_Triangular_across_RWTIlc.pdf      %
% Fig.D.15:  ./plots/fig_D13_D14_D15/AA_Triangular_across_RGSCIlc.pdf     %
%                                                                         %
...
for z = 1:UU
    ...
    dataOpt.varendo         = {'IP','CPI','CCPI','SPRDUeom','XtoM','TVOL','NER','POL','IR','GBY','CBCFCI','CBCRA','CBCXFI','CBCFIHUSD','CBCEHUSD','RGSCIlc','RWTIlc'};
    dataOpt.varendo_global  = {'USIP','USCPI','USCCPI','USSPRDUeom','USXtoM','USTVOL','USNER','USGBY','USCBCFCI','USCBCRA','USCBCXFI','USCBCFIHUSD','USCBCEHUSD','GZEBP','VIX','GEAI','GS1'};
    ...
    plotOpt.folder          = 'fig_D13_D14_D15';    %either a folder name or []
    ...
    stoFolder = 'sto_AEs_LC';                      %folder where to save IRF mat files
...
dataOpt.varplot = {'RGSCIlc','RWTIlc','GS1'};
plotOpt.whichPlot = 'varplot1';
