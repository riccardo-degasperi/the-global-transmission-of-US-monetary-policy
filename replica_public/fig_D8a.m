...
%                                                                         %
% Replica of Figure D.8.a                                                 %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.8.a :  ./plots/fig_D8/overlay/AE_BS_comparison.pdf                %
%                                                                         %
...
EMmodelOpt = load('sto_AEs_BS/modelOpt');
EMdataOpt  = load('sto_AEs_BS/dataOpt');
EMplotOpt  = load('sto_AEs_BS/plotOpt');
EMmiscOpt  = load('sto_AEs_BS/miscOpt');

% Load IRFs
load('sto_AEs/sto_groupBaseline_BVAR_t');
AEIRF = IRFmedian;
load('sto_AEs_BS/sto_groupBaseline_BVAR_t');
EMIRF = IRFmedian;
