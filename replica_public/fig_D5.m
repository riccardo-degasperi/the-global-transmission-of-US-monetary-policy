...
%                                                                         %
% Replica of Figure D.5                                                   %
%                                                                         %
% URL to the file:                                                        %
% Fig.D.5 :  ./plots/fig_D5/Global_BVAR_multishocks_varplot_1.pdf         %
%                                                                         %
...
for z = 1:UU
    ...
    plotOpt.folder          = ['fig_D5/',shocks{z}]; %either a folder name or []
